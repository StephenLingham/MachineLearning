...
url = 'https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2020-06-12'
...
result = multipleregression.get_rsquared_coefficient(
    dependentVariable, independentVariable1, independentVariable2)
